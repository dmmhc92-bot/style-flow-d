#!/usr/bin/env python3
"""
StyleFlow Corrected Comprehensive API Audit
Testing ALL endpoints with correct data structures
"""
...
class StyleFlowCorrectedAPITester:
    def __init__(self):
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                ...
                if "token" in data and "user" in data:
                    ...
                    # Extract user ID from the response or get it from /me endpoint
    ...
    def test_appointments_endpoints(self):
        ...
        appointment_data = {
            "client_id": client_id,
            "appointment_date": "2024-12-25T14:00:00",
        ...
        if self.test_appointment_id:
            update_data = {
                "client_id": client_id,
                "appointment_date": "2024-12-26T15:00:00",
    ...
    def test_formulas_endpoints(self):
        ...
        formula_data = {
            "client_id": client_id,
            "formula_name": "Blonde Highlights",
            "formula_details": "20vol developer + L'Oreal 9.1 - Process for 30 minutes"
        }
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                data = response.json()
                if "id" in data and data.get("formula_name") == "Blonde Highlights":
        ...
        # Test 3: GET /api/formulas/{id} - Get formula (this endpoint doesn't exist in the routes, so we'll skip)
        print("\n🔍 Testing GET /api/formulas/{id}")
        print("⚠️ SKIP - Endpoint not implemented in backend routes")
        ...
        if self.test_formula_id:
            update_data = {
                "client_id": client_id,
                "formula_name": "Updated Blonde Highlights",
                "formula_details": "30vol developer + L'Oreal 10.1 - Process for 35 minutes"
            }
            ...
            try:
                ...
                if response.status_code == 200:
                    data = response.json()
                    if data.get("formula_name") == "Updated Blonde Highlights":
    ...
    def run_comprehensive_audit(self):
        ...
        print("🚀 STARTING STYLEFLOW CORRECTED COMPREHENSIVE API AUDIT")
        print("=" * 80)
        ...
        print("\n" + "=" * 80)
        print("📊 CORRECTED COMPREHENSIVE API AUDIT SUMMARY")
        print("=" * 80)
...
if __name__ == "__main__":
    tester = StyleFlowCorrectedAPITester()
