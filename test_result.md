...
agent_communication:
    - agent: "main"
      message: "COMPLETE SYSTEM AUDIT. Test ALL endpoints: AUTH (login, signup, logout, me, delete-account), CLIENTS (CRUD + data stickiness), FORMULAS (CRUD), APPOINTMENTS (CRUD), POSTS (CRUD + report), PROFILES (hub, avatar, portfolio), ADMIN (guardian, moderation). Verify data persists correctly for each user. Credentials: admin@styleflow.com / Admin1234!"
    - agent: "testing"
