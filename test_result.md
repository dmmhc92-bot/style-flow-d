...
agent_communication:
    - agent: "main"
      message: "OMNI-SYSTEM LIVE VERIFICATION. Test ALL critical paths: 1) Auth flow (login, signup) 2) Client CRUD with data stickiness 3) Formula CRUD 4) Appointment CRUD 5) Account deletion endpoint 6) Subscription status 7) Guardian Dashboard 8) Feed/Posts. Use admin@styleflow.com / Admin1234!"
    - agent: "testing"
