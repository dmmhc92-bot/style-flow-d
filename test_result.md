...
agent_communication:
    - agent: "main"
      message: "PRODUCTION VERIFICATION - FULL SYSTEM TEST. Verify all critical flows for Apple App Store submission: 1) AUTH: Login with appreview@apple.com / AppleTest123! and admin@styleflow.com / Admin1234! 2) DASHBOARD: Stats endpoint returning correct data 3) CLIENTS CRUD: Create, read, update, delete 4) FORMULAS CRUD: Full operations 5) APPOINTMENTS CRUD: Full operations 6) POSTS/FEED: Create posts, get feed 7) AI ASSISTANT: POST /api/ai/chat 8) PROFILES: GET /api/profiles/me 9) FOLLOWING/FOLLOWERS: GET /api/users/following and /followers 10) PORTFOLIO/GALLERY: Full CRUD. Production backend is https://homestyleflowapp.com. Local testing on port 8001."
    - agent: "testing"
